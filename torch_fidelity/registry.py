...
from torch_fidelity.datasets import TransformPILtoRGBTensor, Cifar10_RGB, Cifar100_RGB, STL10_RGB, ImageNetValidation
...
register_dataset(
    'cin',
    lambda root, download: ImageNetValidation()
)
